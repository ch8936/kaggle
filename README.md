...
本次竞赛需利用学生在2013/09至2014/09的数据，预测学生在2014年的助学金获得情况；利用学生在2014/09至2015/09的数据，预测学生在2015年的助学金获得情况。虽然所有数据在时间上混合在了一起，即训练集和测试集中的数据都有2013/09至2015/09的数据，但是学生的行为数据和助学金数据是对应的。
